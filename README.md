...
This repository contains Python code to interface with the EnduroSat OBC over RS485 using an FTDI USB-RS485 cable. It supports receiving and acknowledging commands, file transfers, and other gateway operations.
...
| ------------------ | --------------- |
| H1-37: RS485\_1\_N | Yellow          |
| H1-38: RS485\_1\_P | Orange          |
| H2-31: GND         | Black           |
...
- Upload any file through the Gateway.
- The script will automatically save received files in the `./Data/` directory.
